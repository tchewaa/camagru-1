...
<div class="col-md-4 col-md-offset-4 jumbotron">
    ...
    <form class="form" action="<?=PROOT?>register/registerUser" method="post">
        ...
        <?= FormHelper::inputBlock('password','Confirm Password','confirmPassword',(isset($this->user) ? $this->user->getConfirmPassword() : ''),['class'=>'form-control input-sm'],['class'=>'form-group']) ?>
