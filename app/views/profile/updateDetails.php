...
<!--        FormHelper::displayErrors($this->displayErrors)-->
        <?= FormHelper::inputBlock('text','First Name','first_name',"",['class'=>'form-control input-sm'],['class'=>'form-group']) ?>
        <?= FormHelper::inputBlock('text','Last Name','last_name',"",['class'=>'form-control input-sm'],['class'=>'form-group']) ?>
